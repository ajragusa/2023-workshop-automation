...
def main():
    ...
    with open(CUSTOMERS_FILENAME) as f:
        ...
        # If we didn't see anything in the customers file, raise an exception.
    ...
    for row in customer_interfaces:
        ...
        # Then, find the interface within that device.
        interface_dict = find_interface(device_dict, row["interface"])

        # Finally, at the customer into the interface we found.
